...
ShinyKeyboard::ShinyKeyboard(Touch &ts, DisplayCore &dev, int x, int y, int scale, color_t colHi, color_t colLo, color_t colPressHi, color_t colPressLo, color_t colFont, const uint8_t *font)  : Widget(ts, dev, x, y),
            btn_backtick         (ts, dev, KEYPOS(0, 0),     KEYSIZE(4, 4),      colHi, colLo, "`", 0, colFont, font),
            btn_1                (ts, dev, KEYPOS(4, 0),     KEYSIZE(4, 4),      colHi, colLo, "1", 0, colFont, font),
            btn_2                (ts, dev, KEYPOS(8, 0),     KEYSIZE(4, 4),      colHi, colLo, "2", 0, colFont, font),
            btn_3                (ts, dev, KEYPOS(12, 0),    KEYSIZE(4, 4),      colHi, colLo, "3", 0, colFont, font),
            btn_4                (ts, dev, KEYPOS(16, 0),    KEYSIZE(4, 4),      colHi, colLo, "4", 0, colFont, font),
            btn_5                (ts, dev, KEYPOS(20, 0),    KEYSIZE(4, 4),      colHi, colLo, "5", 0, colFont, font),
            btn_6                (ts, dev, KEYPOS(24, 0),    KEYSIZE(4, 4),      colHi, colLo, "6", 0, colFont, font),
            btn_7                (ts, dev, KEYPOS(28, 0),    KEYSIZE(4, 4),      colHi, colLo, "7", 0, colFont, font),
            btn_8                (ts, dev, KEYPOS(32, 0),    KEYSIZE(4, 4),      colHi, colLo, "8", 0, colFont, font),
            btn_9                (ts, dev, KEYPOS(36, 0),    KEYSIZE(4, 4),      colHi, colLo, "9", 0, colFont, font),
            btn_0                (ts, dev, KEYPOS(40, 0),    KEYSIZE(4, 4),      colHi, colLo, "0", 0, colFont, font),
            btn_minus            (ts, dev, KEYPOS(44, 0),    KEYSIZE(4, 4),      colHi, colLo, "-", 0, colFont, font),
            btn_equals           (ts, dev, KEYPOS(48, 0),    KEYSIZE(4, 4),      colHi, colLo, "=", 0, colFont, font),
            btn_backspace        (ts, dev, KEYPOS(52, 0),    KEYSIZE(8, 4),      colHi, colLo, "<=", 0, colFont, font),
            btn_tab              (ts, dev, KEYPOS(0, 4),     KEYSIZE(6, 4),      colHi, colLo, "=>", 0, colFont, font),
            btn_q                (ts, dev, KEYPOS(6, 4),     KEYSIZE(4, 4),      colHi, colLo, "Q", 0, colFont, font),
            btn_w                (ts, dev, KEYPOS(10, 4),    KEYSIZE(4, 4),      colHi, colLo, "W", 0, colFont, font),
            btn_e                (ts, dev, KEYPOS(14, 4),    KEYSIZE(4, 4),      colHi, colLo, "E", 0, colFont, font),
            btn_r                (ts, dev, KEYPOS(18, 4),    KEYSIZE(4, 4),      colHi, colLo, "R", 0, colFont, font),
            btn_t                (ts, dev, KEYPOS(22, 4),    KEYSIZE(4, 4),      colHi, colLo, "T", 0, colFont, font),
            btn_y                (ts, dev, KEYPOS(26, 4),    KEYSIZE(4, 4),      colHi, colLo, "Y", 0, colFont, font),
            btn_u                (ts, dev, KEYPOS(30, 4),    KEYSIZE(4, 4),      colHi, colLo, "U", 0, colFont, font),
            btn_i                (ts, dev, KEYPOS(34, 4),    KEYSIZE(4, 4),      colHi, colLo, "I", 0, colFont, font),
            btn_o                (ts, dev, KEYPOS(38, 4),    KEYSIZE(4, 4),      colHi, colLo, "O", 0, colFont, font),
            btn_p                (ts, dev, KEYPOS(42, 4),    KEYSIZE(4, 4),      colHi, colLo, "P", 0, colFont, font),
            btn_bktopn           (ts, dev, KEYPOS(46, 4),    KEYSIZE(4, 4),      colHi, colLo, "[", 0, colFont, font),
            btn_bktcls           (ts, dev, KEYPOS(50, 4),    KEYSIZE(4, 4),      colHi, colLo, "]", 0, colFont, font),
            btn_blank            (ts, dev, KEYPOS(54, 4),    KEYSIZE(1, 4),      colHi, colLo, "", 0, colFont, font),
            btn_caps             (ts, dev, KEYPOS(0, 8),     KEYSIZE(7, 4),      colHi, colLo, "Caps", 0, colFont, font),
            btn_a                (ts, dev, KEYPOS(7, 8),     KEYSIZE(4, 4),      colHi, colLo, "A", 0, colFont, font),
            btn_s                (ts, dev, KEYPOS(11, 8),    KEYSIZE(4, 4),      colHi, colLo, "S", 0, colFont, font),
            btn_d                (ts, dev, KEYPOS(15, 8),    KEYSIZE(4, 4),      colHi, colLo, "D", 0, colFont, font),
            btn_f                (ts, dev, KEYPOS(19, 8),    KEYSIZE(4, 4),      colHi, colLo, "F", 0, colFont, font),
            btn_g                (ts, dev, KEYPOS(23, 8),    KEYSIZE(4, 4),      colHi, colLo, "G", 0, colFont, font),
            btn_h                (ts, dev, KEYPOS(27, 8),    KEYSIZE(4, 4),      colHi, colLo, "H", 0, colFont, font),
            btn_j                (ts, dev, KEYPOS(31, 8),    KEYSIZE(4, 4),      colHi, colLo, "J", 0, colFont, font),
            btn_k                (ts, dev, KEYPOS(35, 8),    KEYSIZE(4, 4),      colHi, colLo, "K", 0, colFont, font),
            btn_l                (ts, dev, KEYPOS(39, 8),    KEYSIZE(4, 4),      colHi, colLo, "L", 0, colFont, font),
            btn_semi             (ts, dev, KEYPOS(43, 8),    KEYSIZE(4, 4),      colHi, colLo, ";", 0, colFont, font),
            btn_apos             (ts, dev, KEYPOS(47, 8),    KEYSIZE(4, 4),      colHi, colLo, "'", 0, colFont, font),
            btn_hash             (ts, dev, KEYPOS(51, 8),    KEYSIZE(4, 4),      colHi, colLo, "#", 0, colFont, font),
            btn_return           (ts, dev, KEYPOS(55, 4),    KEYSIZE(5, 8),      colHi, colLo, "Ret", 0, colFont, font),
            btn_lshift           (ts, dev, KEYPOS(0, 12),    KEYSIZE(5, 4),      colHi, colLo, "^", 0, colFont, font),
            btn_bslash           (ts, dev, KEYPOS(5, 12),    KEYSIZE(4, 4),      colHi, colLo, "\\", 0, colFont, font),
            btn_z                (ts, dev, KEYPOS(9, 12),    KEYSIZE(4, 4),      colHi, colLo, "Z", 0, colFont, font),
            btn_x                (ts, dev, KEYPOS(13, 12),   KEYSIZE(4, 4),      colHi, colLo, "X", 0, colFont, font),
            btn_c                (ts, dev, KEYPOS(17, 12),   KEYSIZE(4, 4),      colHi, colLo, "C", 0, colFont, font),
            btn_v                (ts, dev, KEYPOS(21, 12),   KEYSIZE(4, 4),      colHi, colLo, "V", 0, colFont, font),
            btn_b                (ts, dev, KEYPOS(25, 12),   KEYSIZE(4, 4),      colHi, colLo, "B", 0, colFont, font),
            btn_n                (ts, dev, KEYPOS(29, 12),   KEYSIZE(4, 4),      colHi, colLo, "N", 0, colFont, font),
            btn_m                (ts, dev, KEYPOS(33, 12),   KEYSIZE(4, 4),      colHi, colLo, "M", 0, colFont, font),
            btn_comma            (ts, dev, KEYPOS(37, 12),   KEYSIZE(4, 4),      colHi, colLo, ",", 0, colFont, font),
            btn_stop             (ts, dev, KEYPOS(41, 12),   KEYSIZE(4, 4),      colHi, colLo, ".", 0, colFont, font),
            btn_slash            (ts, dev, KEYPOS(45, 12),   KEYSIZE(4, 4),      colHi, colLo, "/", 0, colFont, font),
            btn_rshift           (ts, dev, KEYPOS(49, 12),   KEYSIZE(11, 4),     colHi, colLo, "^", 0, colFont, font),
            btn_lctrl            (ts, dev, KEYPOS(0, 16),    KEYSIZE(6, 4),      colHi, colLo, "Ctrl", 0, colFont, font),
            btn_win              (ts, dev, KEYPOS(6, 16),    KEYSIZE(5, 4),      colHi, colLo, "Win", 0, colFont, font),
            btn_lalt             (ts, dev, KEYPOS(11, 16),   KEYSIZE(5, 4),      colHi, colLo, "Alt", 0, colFont, font),
            btn_space            (ts, dev, KEYPOS(16, 16),   KEYSIZE(24,4),      colHi, colLo, "", 0, colFont, font),
            btn_ralt             (ts, dev, KEYPOS(40, 16),   KEYSIZE(5, 4),      colHi, colLo, "Alt", 0, colFont, font),
            btn_menu             (ts, dev, KEYPOS(45, 16),   KEYSIZE(7, 4),      colHi, colLo, "Menu", 0, colFont, font),
            btn_rctrl            (ts, dev, KEYPOS(52, 16),   KEYSIZE(8, 4),      colHi, colLo, "Ctrl", 0, colFont, font) {
    _scale = scale;
    _font = font;
    _colHi = colHi;
    _colLo = colLo;
...
void ShinyKeyboard::handlePress(Event *e) {
    ...
    w->setBackground(_colPressHi, _colPressLo);
}

void ShinyKeyboard::handleRelease(Event *e) {
    ShinyButton *w = (ShinyButton *)e->source;
    w->setBackground(_colHi, _colLo);
}
